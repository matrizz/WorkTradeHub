...
import ModalCreate from '@/app/components/modal/modalCreate'
            ...
            <div className="mx-auto bg-white flex flex-col min-h-screen gap-20">
                ...
                <div className="flex flex-col items-center gap-10 p-8 bg-white min-h-screen">
                    ...
                    <div className="flex group transition-all duration-300">
                        <button className="group-hover:border-slate-700 group-hover:text-slate-700 text-gray-400 text-lg text-center border-2 p-2 rounded-l-lg flex justify-end hover:text-slate-700 transition-all duration-300">
                            Criar novo serviço
                        </button>
