	...
	return (
		<div className="mx-auto bg-white flex flex-col  gap-20">
			...
			<div className="w-full flex flex-col gap-2">
				<h1 className="w-full flex justify-center text-4xl font-bold text-slate-700">
				...
				<div className="flex w-11/12 flex-col justify-between items-center shadow-xl border-t border-x rounded py-10 px-10 gap-4">
					<div className="flex flex-col w-full gap-8 md:flex-row md:items-start md:justify-start">
						<div className="flex justify-center items-start gap-4 py-4 md:justify-start">
							<img
								className="min-w-56 h-56 border-2 rounded-full"
								src="https://avatars.githubusercontent.com/u/95687945?v=4"
								alt=""
							/>
						</div>
						<div className="w-full flex text-gray-400 flex-col justify-evenly py-2 gap-4">
							<div>
								<div className="w-full flex flex-col">
									...
									<input
										name="name"
										className="border rounded py-1 border-slate-600 px-2 outline-none text-black"
										readOnly
								...
								<div className="w-full flex flex-col">
									...
									<input
										...
										type="text"
										placeholder="Habilidade Específica ex: 'Desenvolvedor Front-end'"
									/>
								</div>
							</div>
							<div className="w-full flex flex-col">
								...
								<input
									...
									type="text"
									placeholder="Habilidades Complementares"
								/>
							</div>
							<div>
								<div className="w-full flex flex-col">
								...
								<div className="w-full flex flex-col">
									...
									<input
										...
										className="border rounded py-1 border-slate-600 px-2 outline-none text-black"
										readOnly
										defaultValue={currentUser.location?.cep}
										type="text"
										placeholder="CEP"
									/>
								</div>
								<div className="w-full flex flex-col">
									...
									<input
										...
										className="border rounded py-1 border-slate-600 px-2 outline-none text-black"
										readOnly
										defaultValue={currentUser.location?.uf}
										type="text"
										placeholder="uf"
									/>
								</div>
					...
					<div className="w-full flex justify-center gap-20 px-10">
						<button className="w-80 h-10 bg-slate-800 text-white px-2">
							Editar
						</button>
					</div>
				</div>
