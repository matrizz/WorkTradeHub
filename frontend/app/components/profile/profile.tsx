...
export const ProfileComponent = async ({ user, auth }: { user: string, auth?: string }) => {

    //@ts-ignore
    const currentUser: UserProps = !auth ? await getUser(user) : await getUserWithAuth(user, auth)
